...
public:
  ...
  void addTask( OBJECT* aCmd , boost::function<void(OBJECT*, std::shared_ptr<ResourceGuardType>, const core::ParameterSet&)> aFunction , const std::shared_ptr<ResourceGuardType>& aResourceGuard, const core::ParameterSet& aParamSet );
   ...
   */
  template<class OBJECT, class ResourceGuardType>
  void addTask( OBJECT* aCmd , boost::function<void(OBJECT*, std::shared_ptr<ResourceGuardType>)> aFunction, const std::shared_ptr<ResourceGuardType>& aResourceGuard );
...
private:
  ...
  static std::unique_ptr<ThreadPool> sInstance;
