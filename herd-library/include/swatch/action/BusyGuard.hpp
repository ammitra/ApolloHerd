...
public:
  ...
  BusyGuard& operator=(const BusyGuard& aGuard) = delete;

  BusyGuard(Functionoid& aAction, ActionableStatus& aStatus, const BusyGuard* aOuterGuard=NULL);
  BusyGuard(Functionoid& aAction, ActionableStatus& aStatus, ActionableStatusGuard& aStatusGuard, const Callback_t& aCallback, const BusyGuard* aOuterGuard=NULL);
