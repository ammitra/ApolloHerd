...
Functionoid::Functionoid( const std::string& aId, const std::string& aAlias, ActionableObject& aActionable ) :
...
const ActionableObject& Functionoid::getActionable() const
{
  return mActionable;
}


ActionableObject& Functionoid::getActionable()
{
  return mActionable;
}
