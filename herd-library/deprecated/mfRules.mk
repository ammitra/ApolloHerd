...
# Library sources 
LibrarySources = $(sort $(wildcard src/common/*.cpp) $(wildcard src/common/*/*.cpp) $(wildcard src/common/*/*/*.cpp))
...
ExecutableSources = $(sort $(wildcard src/common/*.cxx) $(wildcard src/common/*/*.cxx))
# Filter undesired files
